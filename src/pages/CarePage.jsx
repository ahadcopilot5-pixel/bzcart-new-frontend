        ...
        <div className="flex-1 px-5 pt-6">
          ...
          <div className="flex justify-center mb-4">
            <img
              ...
              className="w-full max-w-[280px] object-contain animate-levitate-care"
            />
          </div>
          ...
          <div className="flex flex-row items-center justify-between gap-8 w-full">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="pt-16">
                ...
                <Link
                  to={product.id ? `/product/${product.id}` : "/care/all"}
            ...
            {/* Right Content - Product Image - Levitating */}
            <div className="flex-1 flex flex-col items-center">
              <img
                src={product.image}
                alt={product.name}
                className="w-full max-w-md object-contain animate-levitate-care"
              />
            </div>
          </div>
        </div>
            ...
            {products.map((product) => (
              ...
              >
                <div className="bg-gray-100 rounded-lg aspect-square flex items-center justify-center overflow-hidden p-4">
                  <img
                    src={product.product_images?.[0] || "/care.png"}
...
const CarePage = () => {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      const data = await productAPI.getByCategory("mens-care");
  ...
  const heroProduct = products[0]
    ? {
        ...
        image: products[0].product_images?.[0] || "/care.png",
      }
    : null;

  return (
    <div className="min-h-screen bg-white">
      <CareHero heroProduct={heroProduct} />
      <TrendingCareProducts products={products} loading={loading} />
      <ClientTestimonials />
    </div>
  );
};
